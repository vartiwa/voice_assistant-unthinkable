...
export const CompactSuggestionsWidget: React.FC<CompactSuggestionsWidgetProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-zinc-900 rounded-2xl p-4 border border-slate-200 dark:border-zinc-800 shadow-xs space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
          {habitualSuggestions.map((sug) => {
            ...
            return (
              <div
                key={sug.id}
                className="p-2.5 rounded-xl bg-slate-50 dark:bg-zinc-800/60 border border-slate-200/70 dark:border-zinc-700/70 flex items-center justify-between gap-2"
              >
      ...
      {/* 2. Seasonal Harvest & Weekly Specials Section */}
