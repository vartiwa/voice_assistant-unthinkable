...
export const ShoppingListView: React.FC<ShoppingListViewProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-zinc-900 rounded-3xl p-5 sm:p-6 border border-slate-200/90 dark:border-zinc-800 shadow-xs space-y-5 flex flex-col">
      ...
      {/* ======================================================== */}
      {/* 2. PRODUCT ITEMS LIST (RENDERED FREELY & SPACIOUSLY)     */}
      {/* ======================================================== */}
